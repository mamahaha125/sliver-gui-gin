...
VALUES
     ...
     (61, '文件迁移', '/system/task', 0, 0, 5, 'layui-icon layui-icon-upload-drag', 1, 1, 0, 0, 0, '2021-09-26 15:16:06', '2021-09-26 15:16:06'),
     (62, '任务管理', '/system/task/list', 0, 61, 1, 'layui-icon ', 1, 1, 1, 0, 0, '2021-09-26 15:19:04', '2021-09-26 15:19:04'),
     (63, '服务器管理', '/system/server/list', 0, 61, 2, 'layui-icon ', 1, 1, 1, 0, 0, '2021-09-26 15:19:44', '2021-09-26 15:19:44'),
     (65, '数据', '/system/task/json', 0, 62, 2, 'layui-icon ', 0, 1, 2, 0, 0, '2021-09-26 15:23:23', '2021-09-26 15:23:23'),
     (66, '新增', '/system/task/add', 0, 62, 3, 'layui-icon ', 0, 1, 2, 0, 0, '2021-09-26 15:23:54', '2021-09-26 15:23:54'),
     (67, '修改', '/system/task/edit', 0, 62, 4, 'layui-icon ', 0, 1, 2, 0, 0, '2021-09-26 15:24:35', '2021-09-26 15:24:35'),
     (68, '删除', '/system/task/delete', 0, 62, 5, 'layui-icon ', 0, 1, 2, 0, 0, '2021-09-26 15:25:32', '2021-09-26 15:25:32'),
     (70, '数据', '/system/server/json', 0, 63, 2, 'layui-icon ', 0, 1, 2, 0, 0, '2021-09-26 15:27:57', '2021-09-26 15:27:57'),
     (71, '新增', '/system/server/add', 0, 63, 3, 'layui-icon ', 0, 1, 2, 0, 0, '2021-09-26 15:28:14', '2021-09-26 15:28:14'),
     (72, '修改', '/system/server/edit', 0, 63, 4, 'layui-icon ', 0, 1, 2, 0, 0, '2021-09-26 15:28:52', '2021-09-26 15:28:52'),
     (73, '删除', '/system/server/delete', 0, 63, 5, 'layui-icon ', 0, 1, 2, 0, 0, '2021-09-26 15:29:09', '2021-09-26 15:29:09'),
	 (74, '日志', '/', 0, 0, 6, 'layui-icon layui-icon-form', 1, 1, 0, 0, 0, '2021-10-09 18:48:25', '2021-10-09 18:48:25'),
	 (75, '日志列表', '/system/log/list', 0, 74, 1, 'layui-icon ', 1, 1, 1, 0, 0, '2021-10-09 18:49:08', '2021-10-09 18:49:08'),
	 (76, '操作日志', '/system/log/operate', 0, 75, 2, 'layui-icon ', 1, 1, 2, 0, 0, '2021-10-09 18:50:07', '2021-10-09 18:50:07'),
	 (77, '登陆日志', '/system/log/login', 0, 75, 3, 'layui-icon ', 1, 1, 2, 0, 0, '2021-10-09 18:50:44', '2021-10-09 18:50:44');
