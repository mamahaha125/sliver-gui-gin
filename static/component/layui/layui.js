...
!function (p) {
    ...
    var m, d, e, n = p.layui && layui.define, u = {
        ...
        i = (y.anim = {
            ...
            var l, e,
                r = (t = m("." + y[0]).find("#" + o).closest("." + y[0]))[0] ? (o = t.attr("times"), t) : m("#" + y[0] + o),
...
layui.define(["table"], function (e) {
    ...
    var B = layui.$, x = layui.form, j = layui.table, y = layui.hint(), P = {
        ...
        }, q = "layui-hide", L = ".layui-table-main", Y = ".layui-table-fixed-l", R = ".layui-table-fixed-r",
        s = "layui-table-checked", h = "layui-table-tree", H = "LAY_DATA_INDEX", m = "LAY_DATA_INDEX_HISTORY",
        f = "LAY_PARENT_INDEX", b = "LAY_CHECKBOX_HALF", X = "LAY_EXPAND", z = "LAY_HAS_EXPANDED",
    ...
    t.prototype.init = function () {
        var e = this.config, t = j.render(B.extend({}, e, {data: [], url: "", done: null})), a = t.config.id;
    ...
    var n, U = function (e, t, a) {
        ...
        if (x) if (m) b.nextAll(v.map(function (e, t, a) {
            ...
            if (b.enable && y[f] && !y[V]) {
                ...
                var _ = B.extend({}, b.where || o.where), T = b.autoParam, T = (layui.each(T, function (e, t) {
                        t = t.split("=");
                    ...
                    O = b.dataType || o.dataType, w = b.jsonpCallback || o.jsonpCallback, S = b.headers || o.headers,
            ...
            m = y[z] = !0, v.length && (!o.initSort || o.url && !o.autoSort || ((b = o.initSort).type ? layui.sort(v, b.field, "desc" === b.type, !0) : layui.sort(v, j.config.indexName, null, !0)), c.initData(y[s.children], y[H]), k = j.getTrHtml(d, v, null, null, e), N = {
                ...
                N.trs.eq(e).attr({
                    ...
                    "lay-data-index": t[H],
                    "data-level": I
                }), N.trs_fixed_r.eq(e).attr({"data-index": t[H], "lay-data-index": t[H], "data-level": I})
        ...
        var a = this.getOptions(), n = a.tree;
        ...
        t.id;
        a.hasClass(h) && (r(e), (t.tree || {}).view.dblClickExpand && J({trElem: e.tr.first()}, null, null, null, !0))
        ...
        var a = this.getOptions(), n = (a.tree, a.id), i = a.elem.next(), l = j.config.checkName,
            r = (e && (a = this.updateParentCheckStatus(e, "boolean" === layui.type(t) ? t : null), layui.each(a, function (e, t) {
                var a = i.find('tr[lay-data-index="' + t[H] + '"]  input[name="layTableCheckbox"]:not(:disabled)'),
                    n = t[l];
                a.closest("tr")[n ? "addClass" : "removeClass"](s), x.render(a.prop({checked: n, indeterminate: t[b]}))
            })), !0), d = !1;
        ...
        var n = this, i = n.getOptions(), l = i.id, r = i.elem.next(),
...
layui.define("form", function (e) {
    ...
    var u = layui.$, i = layui.form, p = layui.layer, n = "tree", a = {
        ...
        }, y = "layui-hide", s = "layui-disabled", f = "layui-tree-set", k = "layui-tree-iconClick",
        C = "layui-icon-addition", v = "layui-icon-subtraction", m = "layui-tree-entry", x = "layui-tree-main",
        b = "layui-tree-txt", g = "layui-tree-pack", w = "layui-tree-spread", T = "layui-tree-setLineShort",
        N = "layui-tree-showLine", L = "layui-tree-lineExtend", l = function (e) {
            var i = this;
    ...
    l.prototype.config = {
        ...
        var t = this.config, i = a.children("." + m), n = i.children("." + x),
            l = n.find('input[same="layuiTreeCheck"]'), r = i.find("." + k), i = i.find("." + b),
            c = t.onlyIconControl ? r : n, d = "";
        c.on("click", function (e) {
            var i = a.children("." + g),
                n = (c.children(".layui-icon")[0] ? c : c.find(".layui-tree-icon")).children(".layui-icon");
            i[0] ? a.hasClass(w) ? (a.removeClass(w), i.slideUp(200), n.removeClass(v).addClass(C)) : (a.addClass(w), i.slideDown(200), n.addClass(v).removeClass(C), t.accordion && ((i = a.siblings("." + f)).removeClass(w), i.children("." + g).slideUp(200), i.find(".layui-tree-icon").children(".layui-icon").removeClass(v).addClass(C))) : d = "normal"
        }), i.on("click", function () {
            u(this).hasClass(s) || (d = a.hasClass(w) ? t.onlyIconControl ? "open" : "close" : t.onlyIconControl ? "close" : "open", l[0] && (e.checked = l.prop("checked")), t.click && t.click({
                elem: a,
                state: d,
                data: e
            }))
        ...
        n.prop("disabled") || ("object" != typeof i.children && !e.find("." + g)[0] || e.find("." + g).find('input[same="layuiTreeCheck"]').each(function (e) {
            this.disabled || (i.children[e] && (i.children[e].checked = l), this.checked = l)
        }), (t = function (e) {
            var i, n, a;
        ...
        n.children("." + m).children("." + x).on("click", 'input[same="layuiTreeCheck"]+', function (e) {
            ...
            e.prop("disabled") || (t.setCheckbox(n, a, e), a.checked = i, l.oncheck && l.oncheck({
                elem: n,
                checked: i,
                data: a
            }))
        ...
        e.children(".layui-tree-btnGroup").on("click", ".layui-icon", function (e) {
            ...
            if ("add" == e) {
                a[0] || (o.showLine ? (h.find("." + k).addClass("layui-tree-icon"), h.find("." + k).children(".layui-icon").addClass(C).removeClass("layui-icon-file")) : h.find(".layui-tree-iconArrow").removeClass(y), c.append('<div class="layui-tree-pack"></div>'));
                ...
                }), (a.children("." + f).last().prev().hasClass(T) ? a.children("." + f).last().prev() : a.children("." + f).last()).removeClass(T), !c.parent("." + g)[0] && c.next()[0] && a.children("." + f).last().removeClass(T)) : (l = c.siblings("." + f), n = 1, r = c.parent("." + g), layui.each(l, function (e, i) {
                    u(i).children("." + g)[0] || (n = 0)
                }), 1 == n ? (l.children("." + g).addClass(N), l.children("." + g).children("." + f).removeClass(T), c.children("." + g).addClass(N), r.removeClass(L), r.children("." + f).last().children("." + g).children("." + f).last().addClass(T)) : c.children("." + g).children("." + f).addClass(T))), !o.showCheckbox) return;
                ...
                c.siblings("." + f).children("." + m)[0] ? (o.showCheckbox && (l = function (e) {
                    ...
                    u(i).children("." + g)[0] || (n = 0)
                }), 1 == n ? (a[0] || (i.removeClass(L), e.children("." + g).addClass(N), e.children("." + g).children("." + f).removeClass(T)), (c.next()[0] ? i.children("." + f).last() : c.prev()).children("." + g).children("." + f).last().addClass(T), c.next()[0] || c.parents("." + f)[1] || c.parents("." + f).eq(0).next()[0] || c.prev("." + f).addClass(T)) : !c.next()[0] && c.hasClass(T) && c.prev().addClass(T))) : (e = c.parent("." + g).prev(), o.showLine ? (e.find("." + k).removeClass("layui-tree-icon"), e.find("." + k).children(".layui-icon").removeClass(v).addClass("layui-icon-file"), (i = e.parents("." + g).eq(0)).addClass(L), i.children("." + f).each(function () {
        ...
        var e = this.config, i = [], n = [], t = (this.elem.find(".layui-form-checked").each(function () {
            ...
            layui.each(e, function (e, n) {
                layui.each(i, function (e, i) {
                    if (n.id == i) return n.checked = !0, delete (i = u.extend({}, n)).children, a.push(i), n.children && (i.children = [], t(n.children, i.children)), !0
                })
            })
        });
